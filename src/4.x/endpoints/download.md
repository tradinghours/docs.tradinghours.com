---
description: Enterprise bulk download of the complete dataset as CSV and Excel flat files in a single zip, with the full data dictionary for every table and field.
---
...
| Observed | Indicates that settlement is closed in observance of a holiday that officially falls on another date. ("OBS" or blank) |
| Memo | Additional information, if needed |
